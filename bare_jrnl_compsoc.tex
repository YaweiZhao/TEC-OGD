...
\author{Yawei Zhao, En Zhu$^\ast$, Xinwang Liu, and Jianping Yin$^\ast$  % <-this % stops a space
\thanks{${\ast}$ represents the corresponding authors.}
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem Yawei Zhao, En Zhu, and Xinwang Liu are with the School of Computer, National University of Defense Technology, Changsha, 410073, China. E-mail: \{zhaoyawei, enzhu, xinwangliu\}@nudt.edu.cn. \protect \\
\IEEEcompsocthanksitem Jianping Yin is with the School of Computer, Dongguan University of Technology, Dongguan, Guangdong, 523808, China. E-mail: jpyin@dgut.edu.cn. \protect \\
...
\begin{IEEEkeywords}
Online gradient descent, dynamic regret, query complexity, online convex optimization.
\end{IEEEkeywords}}
